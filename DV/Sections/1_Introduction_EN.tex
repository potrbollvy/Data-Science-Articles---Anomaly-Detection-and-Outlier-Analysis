\section{Data Visualisation/Representation}
\label{sec:DV}
...
%\centering
%\includegraphics[width=0.8\textwidth]{Images/viz_retinal.png}
...
\end{itemize}
\section{A Word About Accessibility}
\begin{tcolorbox}[title=Cubism's Missing Link]
...
%\section{Case Study: Reliability of Canadian Consular Network Data}
