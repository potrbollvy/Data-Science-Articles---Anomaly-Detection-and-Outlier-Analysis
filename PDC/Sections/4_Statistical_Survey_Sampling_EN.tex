...
In \textbf{Simple Random Sampling} ($\SRSS$), $n$ units are selected randomly from the survey frame, as in Figure~\ref{fig:designs} (top left image). \begin{figure*}[t]
\centering
