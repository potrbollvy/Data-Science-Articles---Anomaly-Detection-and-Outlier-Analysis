...
\newl A \textbf{local $k-$region} around a point $\mathbf{p}$ is simply the set of the $k$ nearest neighbours of $\mathbf{p}$ $\Longrightarrow$ need to select a distance measure. \newl 
